...
@router.post("/users/", response_model=User.User, status_code=status.HTTP_201_CREATED)
...
@router.post("/users/login", response_model=User.User)
...
@router.put("/users/", response_model=User.User)
...
@router.get("/users/name/{user_name}", response_model=User.User)
...
@router.get("/users/{user_id}/offers", response_model=User.UserWithOffers)
