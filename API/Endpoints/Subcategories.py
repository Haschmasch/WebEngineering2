...
@router.post("/subcategories/", response_model=Subcategory.Subcategory, status_code=status.HTTP_201_CREATED)
...
@router.put("/subcategories/", response_model=Subcategory.Subcategory)
...
@router.delete("/subcategories/", response_model=Subcategory.Subcategory)
...
@router.get("/subcategories/{subcategory_id}", response_model=Subcategory.Subcategory)
...
@router.get("/subcategories/name/{subcategory_name}", response_model=Subcategory.Subcategory)
...
@router.get("/subcategories/{subcategory_id}/offers", response_model=Subcategory.SubcategoryWithOffers)
...
@router.get("/subcategories/{subcategory_id}/category", response_model=Subcategory.SubcategoryWithCategory)
def get_category_with_offers(subcategory_id: int, db: Session = Depends(setup_database.get_db)):
    try:
        return Subcategories.get_subcategory(db, subcategory_id)
    except exc.DatabaseError as e:
...
@router.get("/subcategories/", response_model=list[Subcategory.Subcategory])
