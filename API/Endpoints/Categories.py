...
@router.post("/categories/", response_model=Category.Category, status_code=status.HTTP_201_CREATED)
...
@router.put("/categories/", response_model=Category.Category)
...
@router.delete("/categories/", response_model=Category.Category)
...
@router.get("/categories/{category_id}", response_model=Category.Category)
...
@router.get("/categories/name/{category_name}", response_model=Category.Category)
...
@router.get("/categories/{category_id}/offers", response_model=Category.CategoryWithOffers)
...
@router.get("/categories/{category_id}/subcategories", response_model=Category.CategoryWithSubcategories)
def get_category_with_offers(category_id: int, db: Session = Depends(setup_database.get_db)):
    try:
        return Categories.get_category(db, category_id)
    except exc.DatabaseError as e:
